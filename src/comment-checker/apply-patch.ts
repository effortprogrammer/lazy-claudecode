...
} from "../shared/comment-checker-core/index.ts";
import type { CheckerEdit as CoreApplyPatchEdit } from "../shared/comment-checker-core/index.ts";
import type { CommentCheckRequest } from "./types.ts";
