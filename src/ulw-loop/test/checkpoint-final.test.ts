...
describe("checkpointUlwLoop final story", () => {
	...
	it("ACCEPTS complete when task-scoped completed Claude Code objective maps to the ulw-loop brief", async () => {
	...
	it("ACCEPTS complete when active task-scoped Claude Code objective maps to the ulw-loop brief", async () => {
	...
	it("keeps aggregate open when non-final task-scoped Claude Code completion maps to the brief", async () => {
