		...
		artifactRefs: [
			{
				...
				path: "packages/lazy-claudecode-claude-code/plugin/components/ulw-loop/test/fixtures/artifacts/cli-pass.txt",
			},
			{
				id: "artifact-cli-reject",
				kind: "log",
				description: "Log proving malformed quality gate rejection.",
				path: "packages/lazy-claudecode-claude-code/plugin/components/ulw-loop/test/fixtures/artifacts/rejection.txt",
			},
		],
	},
	gateReview: {
