...
import { ulwLoopDir, ulwLoopGoalsPath, ulwLoopLedgerPath } from "../src/paths.ts";
import {
	appendLedger,
...
import type { UlwLoopItem, UlwLoopLedgerEntry, UlwLoopPlan } from "../src/types.ts";
import { UlwLoopError } from "../src/types.ts";

const NOW = "2026-05-23T00:00:00.000Z";
const STABLE_OBJECTIVE =
	"Complete the durable ulw-loop plan in .claude/ulw-loop/goals.json, including later accepted/appended stories, under the original brief constraints; use .claude/ulw-loop/ledger.jsonl as the audit trail.";
