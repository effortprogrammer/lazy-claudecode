import type { ApplyPatchAccumulator, ApplyPatchFileMetadata, CheckerEdit } from "./types.ts";
...
export function extractApplyPatchEdits(
	...
	const patch =
		args === undefined ? undefined : getString(args, ["patchText", "input", "patch", "command"]);
