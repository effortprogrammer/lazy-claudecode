...
If team-mode is unavailable (`team_*` tools missing), instruct the user to set `team_mode.enabled: true` in `~/.config/claude-code/lazy-claudecode.jsonc` and restart claude-code.
</hyperplan-mode>
