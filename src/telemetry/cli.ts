...
import { type ClaudeCodeSessionStartInput, runSessionStartHook } from "./claude-hook.ts";
...
if (command === "hook" && subcommand === "session-start") {
	...
	process.stderr.write("Usage: lazy-claudecode-telemetry hook session-start\n");
	process.exitCode = 1;
}
