import type { ContinuationState } from "./boulder-reader.ts";
import { readContinuationState } from "./boulder-reader.ts";
import { START_WORK_CONTINUATION_DIRECTIVE } from "./directive.ts";
import type { ReadonlyFileSystem, StopHookEventName, StopHookOutput, StopInput } from "./types.ts";
...
const CONTEXT_PRESSURE_MARKERS = [
	...
	"context_too_large",
	"claude-code ran out of room in the model's context window",
