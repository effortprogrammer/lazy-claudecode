...
const GIT_BASH_ENV_KEY = "LAZY_CLAUDECODE_GIT_BASH_PATH";
...
const resolveGitBashForCurrentProcess = (input = {}) => {
...
const MAX_TIMEOUT_MS = 30 * 60000;
const EXEC_COMMAND_TIMEOUT_ENV_KEYS = [
	"LAZY_CLAUDECODE_GIT_BASH_TIMEOUT_MS",
	"LAZY_CLAUDECODE_EXEC_COMMAND_TIMEOUT_MS",
	"LAZY_CLAUDECODE_EXEC_COMMAND_TIMEOUT_MS",
