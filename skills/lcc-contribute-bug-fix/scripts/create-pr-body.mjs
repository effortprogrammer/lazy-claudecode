...
export function createLccBugFixPrBody(value) {
...
---
This PR was debugged, implemented, and created with [Lazy-ClaudeCode](https://github.com/effortprogrammer/lazy-claudecode).
...
async function main() {
	...
	await writeFile(outputPath, createLccBugFixPrBody(parsed), "utf8");
}
