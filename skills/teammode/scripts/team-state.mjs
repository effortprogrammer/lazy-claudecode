...
// A team dir is a single child of .claude/teams. This pattern alone blocks "/", "\", and a
...
// Resolve (and confine) a team dir to a single child of <cwd>/.claude/teams.
export function resolveTeamDir(cwd, sessionId) {
	...
	return resolve(cwd, ".claude", "teams", sessionId);
}
...
export async function ensureTeamDir(cwd, sessionId) {
	...
	const teamsRoot = resolve(cwd, ".claude", "teams");
