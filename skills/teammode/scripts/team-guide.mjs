...
export function buildGuide(team) {
	const artifacts = team.paths?.artifacts ?? ".claude/teams/<session_id>/artifacts";
	const teamJson = team.paths?.team ?? ".claude/teams/<session_id>/team.json";
...
export function buildMemberPrompt(team, id) {
	...
	const guide = team.paths?.guide ?? ".claude/teams/<session_id>/guide.md";
	const teamJson = team.paths?.team ?? ".claude/teams/<session_id>/team.json";
