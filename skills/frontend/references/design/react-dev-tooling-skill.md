...
1. **As an agent skill** so your coding agent learns from each scan and avoids the issues next time:
   ...
   Detects Claude Code / Claude Code / Cursor / Claude Code automatically and writes the skill into the right location.
