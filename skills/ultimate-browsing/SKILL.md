...
mkdir -p ~/.local/state/lazy-claudecode-cookies
python3 scripts/extract_cookies.py --browser chrome --domain youtube.com --output ~/.local/state/lazy-claudecode-cookies/youtube.cookies.json
